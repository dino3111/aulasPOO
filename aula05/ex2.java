...
class CalendarYMD {
    ...
    public CalendarYMD(int year, int firstWeekday) {
        this.year = year;
        this.firstWeekday = firstWeekday;
        events = new int[12][];

        for (int i = 0; i < 12; i++) {
            events[i] = new int[DateYMD.monthDays(i + 1, year)]; // Definir tamanho de cada mês
        }
    }
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            if (option == 1) {
                ...
                int year = sc.nextInt();
                System.out.print("Enter first weekday (1=Sunday, 7=Saturday): ");
                int firstWeekday = sc.nextInt();
                calendar = new CalendarYMD(year, firstWeekday);
